...
AUTH_LDAP_BIND_USER = "CN=Username,OU=SERVICEACCT,DC=in,DC=abc,DC=com"  
AUTH_LDAP_BIND_PASSWORD = "password"  # the special bind password for search
#AUTH_LDAP_USERNAME_FORMAT = "cn=%s,OU=FTE,OU=USERS,OU=CORPORATE,OU=RELIANCE JIO,DC=in,DC=abc,DC=com"  # %s is replaced with the provided username
